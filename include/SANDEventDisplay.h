...
public:
  ...
  // static TMarker* GetMarkerFromCluster(const STTCluster& cluster, EColor color);
  // static TLine** GetFilterToPredictionLines(const STTKFTrack& tr, int stepIndex, EColor color);
