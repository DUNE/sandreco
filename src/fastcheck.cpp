...
int main(int argc, char* argv[])
{
  ...
  {  
    ...
    c.SetLogy(true);
    print(c, fout, tDigit, "TMath::Log10(Stt.t)", "", "", "stt; log_{10}(stt time/ns)");
    print(c, fout, tDigit, "TMath::Log10(Stt.de)", "", "", "stt; log_{10}(dE/MeV)");
    c.SetLogy(false);
  ...
  if(tReco)
  {
    ...
    c.SetLogy(true);
    print(c, fout, tReco, "TMath::Log10(track.r)", trackRecoOK, "", "tracks; log_{10}(R/mm)");
    c.SetLogy(false);
    ...
    print(c, fout, tReco, "TMath::Log10(cluster.t)", "", "", "clusters; log_{10}(t/ns)");
    print(c, fout, tReco, "TMath::Log10(cluster.e)", "", "", "clusters; log_{10}(E/MeV)");
  ...
  { 
    ...
    print(c, fout, tEvent, "(particles.tr.ret_ln==0&&particles.tr.ret_cr==0)>>htemp(2,-0.5,1.5)", PrimaryPart, "", "primaries; recoOK==1");    
    
    tEvent->Draw("particles.charge_reco:particles.charge>>htemp(3,-1.5,1.5,3,-1.5,1.5)", PrimaryPart && PartTrackRecoOK, "colztext"); 
    h2 = (TH2D*) gROOT->FindObject("htemp");
    h2->SetStats(false);
    ...
    tEvent->Draw("particles.pxreco:particles.pxtrue>>htemp(200,-2000,2000,200,-2000,2000)", PrimaryPart && PartTrackRecoOK, "colz"); 
    h2 = (TH2D*) gROOT->FindObject("htemp");
    h2->SetStats(false);
    ...
    tEvent->Draw("particles.pyreco:particles.pytrue>>htemp(200,-2000,2000,200,-2000,2000)", PrimaryPart && PartTrackRecoOK, "colz"); 
    h2 = (TH2D*) gROOT->FindObject("htemp");
    h2->SetStats(false);
    ...
    tEvent->Draw("particles.pzreco:particles.pztrue>>htemp(200,-1000,15000,200,-1000,15000)", PrimaryPart && PartTrackRecoOK, "colz"); 
    h2 = (TH2D*) gROOT->FindObject("htemp");
    h2->SetStats(false);
    ...
    tEvent->Draw("particles.Ereco:particles.Etrue>>htemp(200,0,15000,200,0,15000)", PrimaryPart && PartTrackRecoOK, "colz"); 
    h2 = (TH2D*) gROOT->FindObject("htemp");
    h2->SetStats(false);
    ...
    tEvent->Draw("particles.xreco:particles.xtrue>>htemp(200,-2000,2000,200,-2000,2000)", PrimaryPart && PartTrackRecoOK, "colz"); 
    h2 = (TH2D*) gROOT->FindObject("htemp");
    h2->SetStats(false);
    ...
    tEvent->Draw("particles.yreco:particles.ytrue>>htemp(200,-4500,-200,200,-4500,-200)", PrimaryPart && PartTrackRecoOK, "colz"); 
    h2 = (TH2D*) gROOT->FindObject("htemp");
    h2->SetStats(false);
    ...
    tEvent->Draw("particles.zreco:particles.ztrue>>htemp(200,22000,26000,200,22000,26000)", PrimaryPart && PartTrackRecoOK, "colz"); 
    h2 = (TH2D*) gROOT->FindObject("htemp");
    h2->SetStats(false);
