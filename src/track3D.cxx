...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::cell*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("cell", "include/struct.h", 8,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::cluster*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("cluster", "include/struct.h", 28,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::digit*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("digit", "include/struct.h", 61,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::track*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("track", "include/struct.h", 73,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::particle*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("particle", "include/struct.h", 93,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::event*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("event", "include/struct.h", 130,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::track3D*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("track3D", "include/track3D.h", 6,
                  typeid(::track3D), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &track3D_Dictionary, isa_proxy, 4,
                  sizeof(::track3D) );
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::track3D*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *track3D_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::track3D*)0x0)->GetClass();
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<track3D>*)
   {
      ...
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(vector<track3D>));
      static ::ROOT::TGenericClassInfo 
         instance("vector<track3D>", -2, "vector", 210,
                  typeid(vector<track3D>), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &vectorlEtrack3DgR_Dictionary, isa_proxy, 4,
                  sizeof(vector<track3D>) );
      ...
      instance.AdoptCollectionProxyInfo(TCollectionProxyInfo::Generate(TCollectionProxyInfo::Pushback< vector<track3D> >()));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const vector<track3D>*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *vectorlEtrack3DgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const vector<track3D>*)0x0)->GetClass();
...
namespace ROOT {
   ...
   static void *new_vectorlEtrack3DgR(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<track3D> : new vector<track3D>;
   }
   static void *newArray_vectorlEtrack3DgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<track3D>[nElements] : new vector<track3D>[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlEtrack3DgR(void *p) {
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("track3D",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_track3D_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
